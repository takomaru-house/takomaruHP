...
const TOOLS = [
  { id: "spec", num: "01", icon: "specs",
    ...
    url: "https://takomaru-house.github.io/takomaru-tool-SpecBoard/" },
  { id: "madori", num: "02", icon: "plan",
    ...
    url: "https://takomaru-house.github.io/takomaru-tool-MadoriCreate/" },
  { id: "diff", num: "03", icon: "pdfdiff",
    ...
    url: "https://takomaru-house.github.io/takomaru-tool-PDFDiff/" },
  { id: "ytmap", num: "04", icon: "ytmap",
    jp: "注文住宅 YouTube ガイドマップ", en: "YouTube House Guide Map",
    desc: "注文住宅にまつわるYouTube動画を、テーマ別のマインドマップで体系化したガイド。",
    tag: "GUIDE", status: "公開中 / LIVE",
    url: "https://takomaru-house.github.io/takomaru-tool-YoutubeHouseMap/" },
];
